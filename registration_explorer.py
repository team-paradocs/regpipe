...
class PointCloudVisualizerWithRegistration:
    def __init__(self, directories, source_file, markers=[]):
        ...
        self.source_cloud = o3d.io.read_point_cloud(source_file)
        ...
        self.refiner = Refiner('robust_p2pl_icp')
    ...
    def update_visualization(self):
        ...
        current_file_num = current_file.split("bone")[1].split(".")[0]

        print("Current File: ", current_file)

        for file in self.dataset_files:
            if current_file_num in file:
                dataset_file = file
                break
        else:
